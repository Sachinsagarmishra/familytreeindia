...
document.querySelectorAll('a,button,.corp-card,.corp-addon-item,.corp-cert-card,.corp-receive-item').forEach(el=>{
...
document.querySelectorAll('.corp-reveal').forEach(el=>obs.observe(el));
